        ...
        d = {
            ...
            init: function () {
                if (!/baiduinput/gi.test(window.navigator.userAgent)) {
                    ...
                    _hmt.push(["_trackEvent", "首页", "首页app导流浮层展现量"]), t.removeClass("app-guide-hide"), n.setCookie(p, "1", {
                        expires: 5184e6
                    }), this.swipe(), this.bindEvent()
                }
            }, swipe: function () {
                var i = this,
                ...
                if (!(1 >= a)) {
                    ...
                    this.swiperTimer = setInterval(function () {
                        i.curIdx = (i.curIdx + 1) % a, e.removeClass("app-guide-main-left-img-active"), $(e[i.curIdx]).addClass("app-guide-main-left-img-active"), n.removeClass("app-guide-main-left-pagination-index-active"), $(n[i.curIdx]).addClass("app-guide-main-left-pagination-index-active")
                    }, 3e3)
                }
                ...
                $(".app-guide-close").on("click", function () {
                    i.clearSwipeTimer(), t.addClass("app-guide-hide")
                });
                var e = this;
                $(".app-guide-main-left-pagination-index").on("click", function () {
                    ...
                    a.removeClass("app-guide-main-left-img-active"), $(a[e.curIdx]).addClass("app-guide-main-left-img-active"), $(".app-guide-main-left-pagination-index").removeClass("app-guide-main-left-pagination-index-active"), $(this).addClass("app-guide-main-left-pagination-index-active"), e.swipe()
                })
            }
        };
    $(function () {
...
define("translation:widget/translate/common/hash", function (t, n, e) {
    ...
    c.set = function (t, n, e) {
        ...
        if (e = e.replace(/^\#/, ""), e.indexOf("/") > 0) t = e.split("/"), n = t.length > 3 ? {
            from: t[0],
            to: t[1],
        ...
        else if (t = e.split("|"), 2 === t.length) {
            var i = t[1];
            t = t[0].split("2"), n = 2 === t.length ? {
                from: t[0],
                to: t[1],
                query: i
            } : {
        ...
        } else 1 === t.length ? (t = t[0].split("2"), n = 2 === t.length ? {
            from: t[0],
            to: t[1],
            query: ""
        } : {
        ...
        o = {
            init: function () {
                ...
                e.on("click", "#app-read", function () {
                    _hmt.push(["_trackEvent", "首页", "98_首页页面_结果页导流条点击"]), window.open("https://fanyi.baidu.com/appdownload/download.html")
                })
            }, build: function () {
                var t = a("tplAppRead", {});
                e.prepend(t), _hmt.push(["_trackEvent", "首页", "97_首页页面_结果页导流条展现"])
            }
        };
    $(function () {
        o.init()
...
define("translation:widget/translate/sideNav/sideNav", function (t, e, n) {
    ...
    var a = t("translation:widget/common/third_party/template"),
        ...
        k = {
            init: function () {
                k.bindScroll(), k.bindResize(), k.bindClick()
            }, mockScrollingClickFlag: function (t) {
                w = t
            }, scrollToSection: function (t) {
                var e = v[t].topOffset - l;
                w = !0, $("html:not(:animated), body:not(:animated)").animate({
                    scrollTop: e
                }, 300, "swing", function () {
                    var e = i.get("collapse");
                    e.expandSection(v[t].ele), w = !1, k.checkPos()
                })
            }, locateTab: function () {
                var t = b[k.getParamFromUrl("mod")];
                if (t) {
                    var e = $(".nav-item, .nav-sub-item").filter("[data-stat-add='" + t + "']");
                    e.length > 0 && (k.scrollToSection(parseInt(e.attr("data-section-idx"), 10)), window._hmt.push(["_trackEvent", "首页", "37_首页页面_点击目录项_" + t]))
                }
            }, bindClick: function () {
                s.on("click.sideNav", ".nav-item, .nav-sub-item", function (t) {
                    ...
                    if ("undefined" != typeof n.createTextRange) {
                        ...
                        t = 0, e = n.value.length, a.moveStart("character", 0), a.moveEnd("character", 0), a.collapse(!0), a.moveEnd("character", e), a.moveStart("character", t), a.select()
                    } else "undefined" != typeof n.setSelectionRange && (t = 0, e = n.value.length, n.setSelectionRange(t, e));
                    setTimeout(function () {
                        n.focus()
                ...
                $(window).on("resize.sideNav", function () {
                    u = $(window).height(), h && (k.setupPos(), k.checkPos())
                })
            }, bindScroll: function () {
                $(window).on("scroll.sideNav", function () {
                    if (h) {
                        k.setNavPos(), k.checkPos(), clearTimeout(_);
                ...
                if (k.destroyNav(), $(".result-section").each(function (t, e) {
                    var n = $(e),
                    ...
                    r.html(e), h = !0, 1 === v.length && (p = !0), m = s.offset().top, k.setupPos(), k.checkPos(), g || (g = !0, k.locateTab()), window._hmt.push(["_trackEvent", "首页", "68_首页页面_目录导航展现量"])
                }
            }, setNavPos: function () {
                var t = $(window).scrollTop(),
                    e = d.offset().top;
                if (e > m - f && (m = e + f, this.setupPos()), t > m - c) {
                    s.addClass("fixed");
                    var n = window.pageXOffset || 0;
                    s.css("left", -n)
                } else s.removeClass("fixed"), s.css("left", "")
            }, setupPos: function () {
                p || v.forEach(function (t) {
                    var e = t.ele,
                        n = e.height();
                    t.topOffset = e.offset().top, t.bottomOffset = t.topOffset + n
                })
            }, checkPos: function () {
                var t = $(window).scrollTop();
                if (!p && !w) {
                    ...
                    o.removeClass("active").removeClass("in-view"), v.forEach(function (t, s) {
                ...
                r.empty(), s.removeClass("fixed").css("left", ""), v = [], m = 0, h = !1, p = !1, w = !1, clearTimeout(_), _ = 0, d.css("padding-bottom", "")
    ...
    var s, c, d, u = !0,
        ...
        h = {
            buildSimpleMeans: function (t) {
                ...
                if (e.exchange)
                    for (var v in e.exchange) e.exchange[v] && (h = !0);
                if (d.tplData.showExchange = h, "zh" === u && "en" === p && (d.tplData.isZh2En = !0, _hmt.push(["_trackEvent", "首页", "Web中英词典释义卡片展现次数"])), d.tplData.symbols ? (i ? (i.formatDur = n(i.videoTime), d.tplData.queryExplainVideo = i, _hmt.push(["_trackEvent", "首页", "84_首页页面_Web词典释义卡片_讲解视频缩略图展现次数_" + i.videoType])) : o && (d.tplData.baikeImgUrl = o, _hmt.push(["_trackEvent", "首页", "64_首页页面_Web词典释义卡片_图片展现次数"])), d.tplData.isFirstCard = s, c = a("tplSimplemeans", d), e.memory_skill && _hmt.push(["_trackEvent", "首页", "73_首页页面_Web词典释义卡片_记忆技巧展现次数"]), e.derivative && _hmt.push(["_trackEvent", "首页", "80_首页页面_Web词典释义卡片_派生词展现次数"])) : d.tplData.content && (c = a("tplOtherSimplemeans", d)), l.find(".dictionary-wrap").html(c), i) {
                    var m = $(".dictionary-wrap .query-video"),
                        f = !0;
                    m.on("play", function () {
                        f && window._hmt.push(["_trackEvent", "首页", "86_首页页面_Web词典释义卡片_讲解视频首帧播放次数_" + i.videoType]), f = !1
                    }), m.on("ended", function () {
                        window._hmt.push(["_trackEvent", "首页", "87_首页页面_Web词典释义卡片_讲解视频尾帧播放次数_" + i.videoType]), f = !0
                    })
                }
                ...
                $(".translate-wrap").on("click", ".dictionary-wrap .op-sound", function () {
                    t.timer && clearTimeout(t.timer), t.clickSound({
                        target: this
                    })
                    ...
                    _hmt.push(["_trackEvent", "首页", "73_首页页面_点击金山词霸来源"]), window.open("http://www.iciba.com/", "_blank")
                    ...
                    e.css("visibility", "hidden"), e.show(), setTimeout(function () {
                        ...
                        }), e.css("visibility", "visible"), $(".dictionary-wrap .query-video")[0].play()
                    }, 100)
                }).on("click", ".video-close", function () {
                    $(".dictionary-wrap .query-video")[0].pause(), $(".dictionary-wrap .video-container").removeAttr("style")
                    ...
                    if (0 === t.button) {
                        ...
                        var d = $(".dictionary-wrap .video-container"),
                            ...
                            p = u.left,
                            l = u.top;
                        n = t.clientX - p, a = t.clientY - l, d.addClass("dragging"), o = $(window).width(), i = $(window).height(), r = d.width(), s = d.height(), $(document).on("mousemove.dragVideo", function (t) {
                ...
                BTPM.setUrl(n);
                var a;
                e.addClass("op-sound-active"), a && clearTimeout(a), a = setTimeout(function () {
                ...
                if (n.hasClass("op-repeat-running")) i.isover({
                    ...
                    } else u = !0, $(BTPM).off("ended.repeating").on("ended.repeating", function () {
                ...
                $(".op-repeat").removeClass("op-repeat-running").attr("data-hover-tip-text", "复读"), t && t.nopause || BTPM.doPause(), "IE" === BTPM.stage ? clearInterval(s) : (clearTimeout(c), u = !1, $(BTPM).off("ended.repeating"))
                ...
                $(".container").off("click.repeatthing").on("click.repeatthing", "a", function () {
                    var e = $(this),
                        n = e.attr("href") || "";
                    $(".op-repeat").hasClass("op-repeat-running") && !e.hasClass("op-repeat") && ((n.match(/[\.\/]/g) || e.hasClass("collection-btn")) && t.shutdownRepeat(), _hmt.push(["_trackEvent", "首页", "web端其他方式停止复读"]))
                })
...
define("translation:widget/translate/details/collins/collins", function (t, e) {
    ...
    var l = {
        buildCollins: function (t) {
            ...
            BTPM.setUrl(r);
            var s;
            e.addClass("op-sound-active"), s && clearTimeout(s), s = setTimeout(function () {
                e.removeClass("op-sound-active")
    ...
    var a = t("translation:widget/common/environment"),
        ...
        c = {
            buildAd: function () {
                ...
                r.html(n), s = r.find(".app-side-ad"), h = r.find(".trans-side-ad-wrap")
            }, bindEvents: function () {
                $(".translate-wrap").on("click", ".app-side-ad.long", function () {
                    _hmt.push(["_trackEvent", "首页", "90_首页页面_初始状态长banner点击"]), window.open("https://fanyi.baidu.com/appdownload/download.html")
                }).on("click", ".app-side-ad:not(.long)", function () {
                    var t = a.get("hasDetail");
                    _hmt.push(t ? ["_trackEvent", "首页", "94_首页页面_结果页右侧banner点击"] : ["_trackEvent", "首页", "92_首页页面_初始状态右侧banner点击"]), window.open("https://fanyi.baidu.com/appdownload/download.html")
                }), $(".translate-wrap").on("click", ".showad-close-btn", function (t) {
                    $(".trans-side-ad-wrap").hide();
                    var n = (new Date).getTime(),
                        a = Math.floor(n / 864e5);
                    d.setCookie("sideAdClose", a), _hmt.push(["_trackEvent", "首页", "web端侧边栏广告关闭点击"]), t.preventDefault(), t.stopPropagation()
                ...
                var t = a.get("hasDetail"),
                    ...
                    e = !t && !n && !i;
                return s.toggleClass("long", e), e
            }, hideAppQr: function () {
                window.common.hasSideAd && h.hide(), s.removeClass("detail-qr");
                var t = c.updateAppSideAdLong();
                s.show(), _hmt.push(t ? ["_trackEvent", "首页", "89_首页页面_初始状态长banner展现"] : ["_trackEvent", "首页", "91_首页页面_初始状态右侧banner展现"])
            }, showAppQr: function () {
                o ? (h.show(), s.hide(), _hmt.push(["_trackEvent", "首页", "web端侧边栏广告生成"]), _hmt.push(["_trackEvent", "首页", "web端侧边栏广告总展现"])) : (s.addClass("detail-qr"), c.updateAppSideAdLong(), s.show(), _hmt.push(["_trackEvent", "首页", "93_首页页面_结果页右侧banner展现"]))
            }
        };
    $(function () {
        c.buildAd(), c.bindEvents()
        ...
        u = {
            init: function () {
                ...
                var n = 0 === parseInt(i.get("firstModuleId"), 10),
                    e = "",
                    a = t || {};
                a.jd = a.jdweb ? a.jdweb : "", a.img = a.imgweb ? a.imgweb : "", a.isFirstCard = n, e = o("tplTranslator", {
                    tplData: a
                }), s.append(e), window._hmt.push(["_trackEvent", "首页", "49_首页页面_翻译家推荐模块展现次数"])
            }, clickSound: function (t) {
...
define("translation:widget/translate/input/inputCollGroup/inputCollGroup", function (n, o, t) {
    ...
    var i = n("translation:widget/common/third_party/template"),
        ...
        C = {
            show: function () {
                _hmt.push(["_trackEvent", "首页", "17_首页页面_输入框收藏分组列表浮层展示"]), u.empty(), e.getCollGroupListAsync().then(function () {
                    var n = i("tpl-input-ol", {
                        groupList: l.get("collInfo").groupList
                    });
                    u.html(n), m.show(), v.hide(), c.show(), h.addClass("op-favo-hover")
                })
            }, hide: function () {
                c.hide(), s.val(""), p.addClass("disabled-new-group-confirm"), d.hide(), h.removeClass("op-favo-hover")
            }, init: function () {
                ...
                }), p.on("click", C.newGroupAndAddColl), s.keydown(function (n) {
                    return 13 === parseInt(n.keyCode, 10) ? (n.preventDefault(), C.newGroupAndAddColl(), !1) : void 0
                }), f.on("click", function () {
                    C.hide()
                })
...
define("translation:widget/translate/favo/favo", function (t, e, n) {
    ...
    function r(t) {
        this.pos = t.pos || "input", this.$btn = $(t.target), this.ts = 0, this.handles = {
            change: []
        }
    }
    ...
    r.prototype = {
        ...
        init: function (t) {
            var e = t.query.replace(/<br( \/)?>/gi, "&lt;br$1&gt;"),
                n = t.from + "2" + t.to,
                o = +new Date;
            return "input" === this.pos && o - this.ts < 300 && e === this.query && n === this.direction ? void(this.ts = o) : (this.ts = o, this.resetBtn(), this.query = e, this.direction = n, this.dictJSON = t.dictJSON || "", this.type = t.type || "", this.fanyiDst = t.fanyiDst || "", this.$btn.show(), this.check(), this.bindEvent(), this)
        }, resetBtn: function () {
            ...
            this.$btn.on("click.favo", function () {
                ...
                "" !== e.is_login ? (t.saved ? t.deleteItem() : y.getDefaultGroupAsync().then(function () {
                    var e = p.get("collInfo"); - 1 !== e.defaultId ? t.add(e.defaultId) : "input" === t.pos ? w.show() : "zonedword" === t.pos && "none" === $(".zoned-coll-extra-container").css("display") ? g.show() : "keyword" === t.pos && (console.log("haha"), l.createCommonCollGroup({
                    ...
                    $.ajax({
                        ...
                        success: function (o) {
                            if (0 === o.errno ? e.favorIsSaved({
                                ...
                                var i = o.note,
                                    r = o.report;
                                i || (i = ""), r || (r = ""), a.default.dispatch(i || r ? d.updateNoteInfo({
                                    showNotePanel: !0,
                                    noteContent: i,
                                    reportContent: r,
                                    hasModified: !1
            ...
            if (this.query === t.reqQurey && this.direction === t.reqDirection) {
                ...
                n || (e.attr("data-hover-tip-text", "已收藏"), f.isover({
                    target: e[0]
                }), setTimeout(function () {
                    f.isout()
                }, 2e3)), e.attr({
            ...
            if (this.query === t.reqQurey && this.direction === t.reqDirection) {
                ...
                e.attr({
                    "data-hover-tip-text": "添加到收藏夹",
                    title: "添加到收藏夹"
                }).removeClass("op-favo-cur"), t.firstScreen && (e.attr("data-hover-tip-text", "已取消收藏"), f.isover({
                    target: e[0]
                }), setTimeout(function () {
                    f.isout(), e.attr("data-hover-tip-text", "添加到收藏夹")
                }, 2e3))
            }
        }, add: function (t) {
            var e = this;
            return new Promise(function (n, o) {
                ...
                "input" === e.pos ? (i.fanyi_dst = v.parseNormalResult(), i.dict = e.dictJSON ? v.parseDictResult() : "", i.dict_json = e.dictJSON) : "zonedword" === e.pos ? (i.type = e.type, i.fanyi_dst = v.parseZonedWordResult(e.type)) : "keyword" === e.pos && (i.type = 1, i.fanyi_dst = e.fanyiDst);
                var r = p.get("maxCollectionCount");
                if (e.query.length > r || i.fanyi_dst.length > r) return alert("囧, 原文和译文要是在" + r + "字以下就好啦 ^_^"), void o();
                    ...
                    $.ajax({
                        ...
                        success: function (i) {
                            0 === i.errno ? (s.favorIsSaved({
                                ...
                                favorInstance: s
                            }), s.trigger("change"), n()) : (s.favorIsNotSaved({
                                reqQurey: t,
                                reqDirection: e
                            }), o())
                        }, error: function () {
            ...
            return i(regeneratorRuntime.mark(function n() {
                ...
                return regeneratorRuntime.wrap(function (n) {
                    ...
                    case 0:
                        ...
                        return n.next = 4, o.add(0);
                    case 4:
                        return n.next = 6, u.default.newFetch("/pc/collection/modify", {
                            id: o.id,
                            bdstoken: window.bdstoken,
                            note: t
                        });
...
define("translation:widget/translate/input/correct", function (t, r) {
    ...
    var s = {
        ...
        showCorrect: function () {
            ...
            var r = this;
            return !this.isEnglishQuery(t) || t.length > 20 || t.length < 3 ? void $(".trans-correct").hide() : (clearTimeout(e), void(e = setTimeout(function () {
            ...
            if (this.setLastInput(t), !this.isQueryInCheck()) {
                if (!this.isEnglishQuery(t) || t.length > 20 || t.length < 3) return void $(".trans-correct").hide();
...
define("translation:widget/translate/input/urlQueryHandler", function (t, r) {
    ...
    l.tpl = ['<div class="url-tip">', "点击翻译按钮，可以对您输入的网站进行全文翻译。", "</div>"].join(""), l.dealUrlQuery = function () {
        $(".operate-btn").css("display", "none"), $(".ordinary-wrap").length > 0 ? $(".ordinary-wrap").html(this.tpl) : ($(".output-wrap").html(this.tpl), $(".url-tip").css({
            margin: "10px"
        }))
    ...
    var r = t("translation:widget/common/third_party/template"),
        ...
        d = {
            init: function () {
                ...
                }), e = $.trim(i.val()), e && (o.result = e), 0 !== o.type.length || e && $.trim(e) !== $.trim(s) || (l = !1), o
        ...
        n = {
            init: function () {
                ...
                a.setCookie("DOUBLE_LANG_SWITCH", 1, {
                    expires: 2592e6
                }), $(".source-output").show(), $(".output-wrap .op-copy").attr("data-hover-tip-text", "复制双语结果"), _hmt.push(["_trackEvent", "首页", "web端打开双语对照"])
            }, doubleLangNeedShutdown: function () {
                a.setCookie("DOUBLE_LANG_SWITCH", 0, {
                    expires: 2592e6
                }), $(".source-output").hide(), $(".output-wrap .op-copy").attr("data-hover-tip-text", "复制"), _hmt.push(["_trackEvent", "首页", "web端关闭双语对照"])
                ...
                n.hasClass("op-checked") ? (t.hide(), o.show(), a.setCookie("JAPAN_PINYIN_SWITCH", 0, {
                    ...
                    expires: 2592e6
                }), n.removeClass("op-check").addClass("op-checked"), _hmt.push(["_trackEvent", "首页", "web端开启日语假名对照"])), s.sameHeight()
                ...
                n.hasClass("op-checked") ? (t.hide(), o.show(), a.setCookie("LUOMA_PINYIN_SWITCH", 0, {
                    ...
                    expires: 2592e6
                }), n.removeClass("op-check").addClass("op-checked"), _hmt.push(["_trackEvent", "首页", "web端开启韩语罗马音对照"])), s.sameHeight()
                ...
                n.hasClass("op-checked") ? (t.hide(), o.show(), a.setCookie("CHINA_PINYIN_SWITCH", 0, {
                    ...
                    expires: 2592e6
                }), n.removeClass("op-check").addClass("op-checked"), _hmt.push(["_trackEvent", "首页", "web端开启中文拼音对照"])), s.sameHeight()
            }
        };
    ...
    var e = t("translation:widget/common/environment"),
        ...
        a = {
            bindEvents: function () {
                ...
                BTPM.setUrl(n);
                var e;
                $(".ordinary-wrap .op-sound").addClass("op-sound-active"), e && clearTimeout(e), e = setTimeout(function () {
    ...
    var D = {
        init: function () {
            ...
            for (var a = t.data.data, p = t.data.jp_pinyin, u = t.data.phonetic, d = {}, g = $(".select-to-language .language-selected").attr("data-lang"), c = $(".select-from-language .language-selected").attr("data-lang"), D = e.get("rtl"), y = $.inArray(g, D) >= 0, h = $.inArray(c, D) >= 0, w = $.inArray(g, ["ara", "ru", "el"]) >= 0, C = "", I = a.length, k = [], L = [], H = 0; I > H; H++) {
                ...
                k.push(parseInt(a[H] || 0)), Array.isArray(a[H].result) || (a[H].result = []);
            ...
            var q = v.getCookie("DOUBLE_LANG_SWITCH"),
                F = !1;
            "1" === q && (F = !0), d.tplData.doubleLangChecked = F, d.tplData.dir = y ? "rtl" : "ltr", d.tplData.srcDir = h ? "rtl" : "ltr", d.tplData.spell = "", r.getByte(C) <= i.getMaxSoundLength(g) && (d.tplData.spell = encodeURIComponent(C)), d.tplData.spellLang = "", i.isLangSound(g) && (d.tplData.spellLang = "yue" == g ? "cte" : g), w && (d.tplData.needSpace = "yes"), n.config("compress", !0);
        ...
        h = {
            ...
            init: function () {
                ...
                $(".translate-wrap").on("mouseover", ".data-hover-tip", function () {
                    ...
                    c.isout()
                }).on("copy", ".output-bd", $.proxy(this.outputTextIsCopy, this)), g.bindEvents(), v.on("sortChange", function () {
                ...
                var a = t.res;
                return a.error ? void(999 === parseInt(a.error, 10) ? (this.clearOutputWrap(), p.normaltrans({
                    data: {
                        data: [{
                            dst: a.query,
                            src: a.query,
                ...
                var a = t.res,
                    ...
                    r = t.query,
                    s = t.badCaseByForce;
                !e && _hmt.push(["_trackEvent", "首页", "web端总共query数"]), a && (this.clearOutputWrap(), a.trans_result && p.normaltrans({
                    data: a.trans_result
                }), i.default.init(a, n, o, r, s))
            }, clearOutputWrap: function () {
                u.set("hasDetail", !1), d.hideAppQr(), $(".textarea-bg-text").html(""), c.isout(), u.get("needLongtextTip") === !0 ? ($(".output-wrap .output-mod").remove(), u.set("needLongtextTip", !1)) : $(".output-wrap").empty().addClass("output-blank"), o.default.dispatch(s.clearNoteInfo()), f.empty()
            }
        };
    $(function () {
        h.init()
    ...
    var a = t("translation:widget/translate/input/textarea"),
        ...
        h = {
            ...
            clearInput: function (n) {
                i.hide(), e.hide(), c.resetBtn(), this.hideIcon(), r.hide(), a.empty(n), u.clearAndHideSug(), p.clearDocTrans(), t("translation:widget/translate/input/dataTransfer").clearInputImage();
                var s = $(".translateio");
                ...
                s.clearOutputWrap(), d.destroyNav(), this.setEmptyHash()
            }, clearAll: function (t) {
                s.clearOutputWrap(), this.clearInput(t), d.destroyNav(), this.setEmptyHash(), l.sendIndexBannerLog({
                    source: "clear"
                })
            }, showIcon: function () {
                this.clearBtn.show()
...
define("translation:widget/translate/translang/tolang", function (t, n) {
    "use strict";
    var a = (t("translation:widget/common/third_party/template"), t("translation:widget/common/environment"), t("translation:widget/translate/translang/transbtn")),
        ...
        l = {
            init: function () {
                ...
                s.on("click", ".history-remove-all", function (i) {
                    i.preventDefault(), i.stopPropagation(), r.deleteAllStorge(), t.renderHistory({
                        data: null
                    }), _hmt.push(["_trackEvent", "首页", "Web点击历史记录清空按钮"])
                }).on("click", ".history-edit-btn", function (t) {
                    t.preventDefault(), t.stopPropagation(), s.addClass("history-editing")
                }).on("click", ".history-complete", function (t) {
                    t.preventDefault(), t.stopPropagation(), s.removeClass("history-editing")
                ...
                if (t.forceQuitEditingPattern && s.removeClass("history-editing"), i && i.data.length) {
                    ...
                    return h.html(u), void s.removeClass("history-none").show()
                }
                h.html(""), s.addClass("history-none").removeClass("history-editing").show()
        ...
        r = {
            getInputSoundUrl: function () {
                var t = $(".select-from-language .language-selected").attr("data-lang"),
                    n = e.getVal(),
                    r = "";
                return "yue" === t && (t = "cte"), r = a.generateURI({
                    lan: t,
...
define("translation:widget/translate/docTranslate/docTranslate", function (t, n, e) {
    ...
    function o() {
        ...
        var r = "auto" === n && "auto" === e;
        b.find(".doc-view-from-lang").text(r ? "中英互译" : y[n].zhName), b.find(".doc-view-to-lang").text(r ? "" : y[e].zhName), b.find(".doc-view-lang-pair").toggleClass("auto", r), _.show(), C.hide(), b.addClass("loading"), S = null
    }
    ...
    function c(t) {
        if ($("#main-outer").hasClass("doc-trans-view-mode")) {
            var n = {
                ...
                e = Object.assign(n, t);
            E.text(e.title), O.text(e.content), _.hide(), C.show(), q.hide()
        }
    }
    ...
    function d(t) {
        ...
        if (n) {
            ...
            i.type = "text/css", i.innerHTML = r, i.id = "doc-specified-style", document.head.appendChild(i), I.html(o), R.html(o), I.find(".translated-span").each(function (t, n) {
                var e = $(n);
                e.text(e.attr("data-src-str"))
            }), S = $(".doc-whole-container .translated-span"), l(), a && m(), window._hmt.push(["_trackEvent", "首页", "文档翻译_结果页展现，成功展示原文译文对照"]), h()
        } else J.attr("src", "https://view.officeapps.live.com/op/embed.aspx?src=" + T.currTask.url)
    }
    ...
    function u(t) {
        t.stopPropagation(), U.hasClass("generating") || (T.currTask.isHtml && T.currTask.isOriginalOverflow && !localStorage.getItem("doNotTipExportOverflow") ? (window._hmt.push(["_trackEvent", "首页", "77_首页页面_导出提示展示"]), F.show()) : k())
    }
    ...
    function p() {
        ...
        if (Array.isArray(e)) {
            ...
            Object.assign(T.currTask, {
                ...
                to: s,
                token: l
            }), o(), T.clearDocTransMode(), $("#main-outer").addClass("doc-trans-view-mode"), $(".footer").hide(), console.log(1), nn.uploadSuccess(), g().then(function (t) {
                var n = t.isHtml,
                    e = t.data;
                if ($("#main-outer").hasClass("doc-trans-view-mode")) {
                    var a = !1;
                    ...
                    Object.assign(T.currTask, {
                        isHtml: n
                    }), _.removeAttr("style"), C.removeAttr("style"), b.removeClass("loading").addClass("viewing-" + (n ? "html" : "file")), d({
                        isHtml: n,
                        data: e,
                        isOriginalOverflow: a
                    }), n && (tn = !0, P.scrollTop(0))
                }
            }, c)
        }
    }
            ...
            var t = a(regeneratorRuntime.mark(function n() {
                ...
                return regeneratorRuntime.wrap(function (n) {
                    ...
                    case 9:
                        ...
                        return nn.complete(), n.next = 14, i(600);
                    case 14:
                        return o = !0, "string" != typeof a.data && (o = !1), n.abrupt("return", {
                            isHtml: o,
        ...
        k = function () {
            var t = a(regeneratorRuntime.mark(function n() {
                ...
                return regeneratorRuntime.wrap(function (n) {
                    for (;;) switch (n.prev = n.next) {
                    case 0:
                        if (window._hmt.push(["_trackEvent", "首页", "82_首页页面_开始导出"]), !U.prop("data-has-gen-link")) {
                            n.next = 6;
                            break
                        }
                        window.location.href = "https://fanyi-doc.baidu.com/doctrans/download?fileToken=" + T.currTask.token, window._hmt.push(["_trackEvent", "首页", "83_首页页面_成功导出"]), n.next = 22;
                        break;
                    case 6:
                    ...
                    case 10:
                        ...
                        return U.removeClass("generating").prop("data-has-gen-link", !0), window.location.href = "https://fanyi-doc.baidu.com/doctrans/download?fileToken=" + T.currTask.token, window._hmt.push(["_trackEvent", "首页", "83_首页页面_成功导出"]), n.abrupt("return");
                    case 18:
                        return n.next = 20, i(X);
                    case 20:
                        n.next = 7;
                        break;
                    case 22:
    ...
    $.fn.scrollEnd = function (t) {
        ...
        $(this).scroll(function (e) {
            var a = $(this);
            return a.is(A) && tn ? void(tn = !1) : (a.data("scrollTimeout") && clearTimeout(a.data("scrollTimeout")), void a.data("scrollTimeout", setTimeout(function () {
                t(e), a.data("scrollTimeout", 0)
            }, n)))
        })
    };
    var nn = T.progress;
    ! function () {
        x.on("uploadSuccess", function (t, n) {
            ...
            $(t.currentTarget).is(q) ? window._hmt.push(["_trackEvent", "首页", "文档翻译_loading点击退出按钮"]) : $(t.currentTarget).is(N) && window._hmt.push(["_trackEvent", "首页", "文档翻译_文档解析失败点击退出按钮"]), location.hash = "", T.clearDocTrans(!1)
        }), M.add(D).on("click", function (t) {
            $(t.currentTarget).is(D) ? window._hmt.push(["_trackEvent", "首页", "76_首页页面_点击上传新文档按钮"]) : $(t.currentTarget).is(M) && window._hmt.push(["_trackEvent", "首页", "文档翻译_文档解析失败点击重新上传"]), location.hash = "", T.clearDocTrans(!0)
        }), U.on("click", u), F.on("click", function (t) {
            return t.stopPropagation()
        }), L.on("click", function () {
            L.hasClass("checked") || window._hmt.push(["_trackEvent", "首页", "78_首页页面_选中导出提示中不再提示复选框"]), L.toggleClass("checked")
        }), z.on("click", function () {
            window._hmt.push(["_trackEvent", "首页", "79_首页页面_点击导出提示中确认导出"]), L.hasClass("checked") && localStorage.setItem("doNotTipExportOverflow", "true"), F.hide(), k()
            ...
            var n = $(t.currentTarget),
                ...
                r = null,
                o = null;
            A.find(n).length > 0 ? (a = A, r = H) : (a = H, r = A), o = r.find(".translated-span[data-span-idx='" + e + "']"), n.add(o).addClass("hover");
            var i = B,
                s = i + r.height(),
                c = o.offset().top,
                d = c + o.height(),
                l = d - s;
            if (l > 0) r.is(A) && (tn = !0), r.scrollTop(r.scrollTop() + l);
            else {
                var u = i - c;
                u > 0 && (r.is(A) && (tn = !0), r.scrollTop(r.scrollTop() - u))
            }
        }), j.on("mouseleave", "span.translated-span", function () {
            S.removeClass("hover")
        }), A.scrollbar(), H.scrollbar(), P.on("scroll", function (t) {
            if (0 !== S.length) {
                var n = $(t.currentTarget);
                if (n.is(":hover")) {
                    ...
                    do {
                        var l = o.eq(d++),
                            u = l.offset().top - i;
                        u > 0 && (s = l, s.is(".not-translated-para") && (c = !1), a = u, r = l.attr(c ? "data-span-idx" : "data-para-idx"))
        ...
        A.scrollEnd(function () {
            function t(t) {
                ...
                a.push(t), r.push(e), n && T.currTask.translatingParaIdxSet.add(s), o.push(s), i += v(e) + 1
            }
            if ($("#main-outer").hasClass("doc-trans-view-mode") && T.currTask.isOverflow) {
                ...
                do {
                    ...
                    var f = c.offset().top,
                        p = f + c.height(),
                        h = p - B;
                    u = f - B, d = u >= K * Z, T.currTask.translatingParaIdxSet.has(c.attr("data-para-idx")) || d || (h > 0 ? e = c : u > -(K * Y) && t(c, !1))
                ...
                if (null !== e) {
                    ...
                    for (K > u && V.show(), o.forEach(function (t) {
                    ...
                    $.ajax({
                        ...
                        success: function (t) {
                            if ($("#main-outer").hasClass("doc-trans-view-mode")) {
                                if (m(), 0 !== t.errno) return void V.hide();
                                var n = [];
                                ...
                                for (var e = r.length - n.length, i = 0; e > i; i++) n.push(null);
                                a.forEach(function (t, e) {
                                    var a = H.find("[data-para-idx='" + o[e] + "']"),
                                        r = n[e],
                                        i = t.add(a);
                                    if (i.removeClass("not-translated-para"), i.removeAttr("data-para-idx"), null === r) i.text("");
                                    else {
                                        var s = r.srcArray,
                                            c = r.dstArray,
                                            d = t,
                                        ...
                                        s.forEach(function (t, n) {
                                            var e = c[n],
                                                a = d.add(l);
                                            d.text(t), l.text(e), a.addClass("translated-span");
                                            var r = T.currTask.translatedSpanCounter++;
                                            if (a.attr("data-span-idx", r), n < s.length - 1) {
                                                var o = d.clone(),
                                                    i = l.clone();
                                                d.after(o), l.after(i), d = o, l = i
                                            }
                                        })
                                    }
                                }), l(), 0 === A.find(".not-translated-para").length && (T.currTask.isOverflow = !1), S = j.find(".translated-span"), V.hide()
                            }
                        }, error: function () {
                            m(), V.hide()
                        }
            ...
            $("#main-outer").hasClass("doc-trans-view-mode") && b.hasClass("viewing-html") && (l(), h())
        }), $(p)
    }(), e.exports = {
        loading: o,
        onHashChange: p
...
define("translation:widget/translate/input/events", function (t, n) {
    ...
    function i(t) {
        l(t), A || g.onRtTrans(t), D.updateManualTransBtn()
    }

    function r(t) {
        t.stopPropagation(), (!E.pasteCompatibility || E.handle(t)) && (g.onRtTrans(t, "paste"), T.switchFontSize())
    }
    ...
    function l(t) {
        ...
        if (S.hideWrap(), v.onHistoryInput(), b.onAdLinkInput(), n) {
            if (13 === t.which) return C.getCloseSugByEnter() && C.setCloseSugByEnter(!1), void(C.getTranslatedByKeyDown() ? C.setTranslatedByKeyDown(!1) : m.onTranslate({
                transtype: "enter"
            }));
            c.hasQuery(n), B.get("shouldClearPromptOnInput") && (h.hide(), B.set("shouldClearPromptOnInput", !1))
        } else k.translateStopRepeat() || k.shutdownAudio(), f.clearAll(!1)
    }
    ...
    n.onClearBtnClick = function () {
        return $("#main-outer").hasClass("doc-trans-mode") ? (window._hmt.push(["_trackEvent", "首页", "文档翻译_上传后点x删除文档"]), void(location.href = "/")) : (k.translateStopRepeat() || k.shutdownAudio(), f.clearAll(), T.switchFontSize(), C.clearAndHideSug(), void D.updateManualTransBtn())
    }, n.init = function () {
        function n(t) {
            var n = E.pasteCompatibility || E.dragCompatibility;
            I.logWrongFileFormat(t), alert("目前仅支持 " + (window.common.pdfHit ? "pdf、" : "") + "docx、doc、ppt、pptx、xls、xlsx" + (n ? "、jpg、png、bmp、jpeg " : " ") + "格式哦")
        }
        var l = this,
            g = this;
        y.on("compositionstart", a).on("compositionend", o).on("input", i).on("keyup", i).on("paste", r).on("keydown", s), $(document).on("paste", function (t) {
            E.pasteCompatibility && E.handle(t)
        }), f.getElem().on("click", function (t) {
            t.preventDefault(), g.onClearBtnClick(), _hmt.push(["_trackEvent", "首页", "web端点击清空输入框"])
        }), u.getElem().on("click", function (t) {
            t.preventDefault(), k.judgeStopRepeat(), g.timer && clearTimeout(g.timer);
            var n = w.getInputSoundUrl();
            d.makeSound(this, n), _hmt.push(["_trackEvent", "首页", "web端原文发音TTS"]), _hmt.push(["_trackEvent", "首页", "web端点击发音按钮"])
            ...
            if ("hover" === B.get("soundTriggerMode")) {
                ...
                g.timer = setTimeout(function () {
                    k.judgeStopRepeat();
                    var n = w.getInputSoundUrl();
                    d.makeSound(t, n), _hmt.push(["_trackEvent", "首页", "web端原文发音TTS"]), _hmt.push(["_trackEvent", "首页", "web端点击发音按钮"])
                }, 500)
            }
            ...
            t.preventDefault();
            var n = $(this).text();
            p.onCorrect(n), _hmt.push(["_trackEvent", "首页", "web端query纠错点击次数"])
        }), $(".trans-prompt").on("click", ".source-lang", function (t) {
            t.preventDefault();
            var n = $(this).attr("data-lang");
            h.onPrompt(n), _hmt.push(["_trackEvent", "首页", "web端点击语种检测提示"])
            ...
            var n = $(t.target);
            (n.hasClass("input-wrap") || n.hasClass("textarea-wrap")) && (t.preventDefault(), c.focus())
        }), x.bindEvent();
        var m = $("#image-holder"),
            v = $("#preview-img"),
            T = $(".translateio");
        m.on("click", function () {
            if (v.is(":hidden")) {
                ...
                t.onload = function () {
                    ...
                    setTimeout(function () {
                        n.revokeObjectURL(t)
                    }, 1e3), T.addClass("is-zoom-in");
                    try {
                        $(window).trigger("resize")
                    } catch (e) {}
                }, t.src = n.createObjectURL(m.data("file")), _hmt.push(["_trackEvent", "首页", "56_首页页面_点击放大缩略图的次数"])
            } else {
            ...
            if ("/docTransMode" === e) I.currTask.file ? ($(".doc-trans-file").text(I.currTask.file.name), I.clearDocTransViewMode(), $("#main-outer").addClass("doc-trans-mode"), z.hide(), localStorage.getItem("docTransLangGuideFlag") || ($(".doc-trans-operation").addClass("guiding"), $(".doc-trans-operation .doc-trans-dir").addClass("open"))) : I.clearDocTrans();
            else if (I.viewModeRegExp.test(e)) {
                var a = t("translation:widget/translate/docTranslate/docTranslate");
                a.onHashChange()
            } else I.clearDocTrans(), t("translation:widget/translate/input/autoRequest").onHashChange()
            ...
            var t = e(regeneratorRuntime.mark(function a(t) {
                ...
                return regeneratorRuntime.wrap(function (a) {
                    ...
                    case 0:
                        ...
                        return a.next = 4, L.ensureUserLoginAsync();
                    case 4:
                        if (e = window.common.docLangHit ? 30 : 10, !(t.size > 1024 * e * 1024)) {
                            a.next = 10;
                            break
                        }
                        return R.removeFile(t, !0), window._hmt.push(["_trackEvent", "首页", "文档翻译_提示大小超限"]), alert("文档大小目前仅支持 " + e + "M 以内，建议拆分文档重试哦"), a.abrupt("return");
                    case 10:
                        f.clearAll(), I.currTask.file = t, I.currTask.fileName = t.name, location.hash = "/docTransMode", a.next = 18;
                        break;
                    case 16:
                        t.type.startsWith("image/") && (E.pasteCompatibility || E.dragCompatibility) ? E.processImgFile(t.getSource().source) : n(t), R.removeFile(t, !0);
                    case 18:
                    case "end":
                        return a.stop()
                    }
            ...
            Boolean(B.get("account").is_login) || window.common.docTransWithoutLogin ? $("#upload-btn-hidden").find('input[type="file"]').click() : L.newLoginInstanceAsync(), _hmt.push(["_trackEvent", "首页", "75_首页页面_点击上传文档按钮"])
        });
        var C = localStorage.getItem("hasShowDocTip");
        C || ($("#upload-btn").addClass("with-first-tip"), $(window).on("click.hideDocTip", function () {
            $("#upload-btn").removeClass("with-first-tip"), $(window).off("click.hideDocTip"), localStorage.setItem("hasShowDocTip", "true")
        })), $(window).on("click.stopSound", function (t) {
            var n = $(t.target);
            n.hasClass("icon-sound") || n.hasClass("op-sound") || n.hasClass("sound-btn") || n.hasClass("icon-repeat") || n.hasClass("op-repeat") || n.hasClass("usecase-sound") || (BTPM.doPause(), k.shutdownRepeat(), $(".op-sound").removeClass("op-sound-active"))
        });
        var _ = [32, 13];
...
define("translation:widget/translate/input/dataTransfer", function (t, e, n) {
        ...
        if (r) {
            ...
            for (var l = r.length - 1; l >= 0; l--) {
                ...
                if ("file" === p) {
                    ...
                    if (m.startsWith("image/")) {
                        ...
                        E.logWrongFileFormat(f), alert("目前仅支持 " + (window.common.pdfHit ? "pdf、" : "") + "docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
                        break
                    }
                }
            }
            ...
            for (var g = a.length - 1; g >= 0; g--) {
                ...
                if ("drop" === e && window.common.docHit && !E.isUrlFileInEdge(v)) {
                    E.logWrongFileFormat(v), alert("目前仅支持 " + (window.common.pdfHit ? "pdf、" : "") + "docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
                    break
                }
            }
        if (i) {
            if (t.preventDefault(), _hmt.push("drop" === e ? ["_trackEvent", "首页", "53_首页页面_上传图片方式_拖拽"] : ["_trackEvent", "首页", "53_首页页面_上传图片方式_复制"]), !c()) return h(o, !1), !1
        } else if (s) return t.preventDefault(), "drop" === e && window._hmt.push(["_trackEvent", "首页", "文档翻译_拖入上传"]), b.addFiles(u), !1;
        return !0
    }
    ...
    function i(t) {
        ...
        C.css("background-image", "url('" + n + "')"), C.data("file", t);
        var r = new Image;
        r.onload = function () {
            var t = this.src;
            setTimeout(function () {
    ...
    function s(t, e, n) {
        return new Promise(function (r, a) {
            ...
            return alert(t), g(!1), Promise.reject()
        })
    }

    function u(t) {
        return new Promise(function (e, n) {
            if (t.size > O) return _hmt.push(["_trackEvent", "首页", "57_首页页面_浏览器弹窗提示_图片大小超过10M"]), void n("您上传的图片已超过" + F + "M，请重新上传");
            var r = !1;
            if (null == t.name) {
    ...
    function d(t) {
        return D.includes(t) || "auto" === t ? !0 : (alert("当前语言不支持图片识别，请选择语言"), y.fromBtnClicked(), !1)
    }

    function p(e, n) {
        if (j.removeClass("with-loading-ocr-tip"), 0 !== e.errno || 0 === e.errno && 0 === e.data.src.length) {
            t("translation:widget/translate/input/clear").show(), w.set("shouldClearPromptOnInput", !0);
            ...
            var a = e.data.src.join(""),
                i = e.data.from,
                o = v.getElem();
            o.val(a), w.set("isProcessOcrResult", !0);
            ...
            _hmt.push(["_trackEvent", "首页", "58_首页页面_对应语言上传图片的次数_" + i]), c.translateAfterOcr(i, a)
        }
    }

    function m() {
        C.css("background-image", "none"), j.removeClass("with-image"), C.data("file", null)
    }
    ...
    function g(t) {
        j.toggleClass("with-loading-ocr-tip", t), $("body").toggleClass("no-interaction", t), U = t
    }
            ...
            var e = r(regeneratorRuntime.mark(function n(e, r) {
                ...
                return regeneratorRuntime.wrap(function (n) {
                    ...
                    case 0:
                        ...
                        return g(!1), n.abrupt("return");
                    case 7:
                        if (r) {
                            n.next = 16;
                            break
                        }
                        return n.next = 10, u(e);
                    case 10:
                        if (m = n.sent) {
                            n.next = 13;
                            break
                    ...
                    case 15:
                        e = n.sent;
                    case 16:
                        return n.next = 18, s(e, c, l);
                    case 18:
                        f = n.sent, r || (i(e), j.addClass("with-image")), p(f, c), g(!1);
                    case 22:
                    case "end":
                        return n.stop()
                    }
    ...
    ! function () {
        if ("1" === window.common.ocrHit) {
            ...
            t && "function" == typeof t.createObjectURL && !x.msie && !x.ucbrowser && window.FormData && "undefined" != typeof window.FileReader && ("draggable" in document.createElement("span") && (I = !0), x.check({
                firefox: "41",
                chrome: "13",
                opera: "12.1"
            }, !0) && (R = !0))
    ...
    var e = a("translation:widget/common/environment"),
        ...
        i = {
            hideFromWrap: function () {
                ...
                var e = t.value,
                    i = o[e].zhName;
                t.isDetected && (i = "检测到<span>" + i + "</span>"), $(".select-from-language .language-selected").attr({
                    "data-lang": e,
                    "data-detected": t.isDetected ? "1" : "0"
                }).attr("data-lang", e).html(i), "auto" === e ? this.autoItemSelected({
                    isDetected: t.isDetected
                }) : this.normalItemSelected({
                    isDetected: t.isDetected
                }), r.changeDir(e), g.changeFrom(e), this.hideFromWrap();
                ...
                s.updateManualTransBtn(), $("body").trigger("updateFromTo.domainTrans")
            }, autoItemSelected: function (a) {
                a.isDetected || e.set("fromLangIsAuto", !0), $(".from-to-exchange .exchange-mask").css({
                    "background-position": "-2px 50%"
                });
                var t = $(".from-to-exchange");
                t.hasClass("language-btn") && t.removeClass("language-btn").addClass("language-btn-disable"), t.attr("aflag", 0)
    ...
    var r = t("translation:widget/common/environment"),
        ...
        i = {
            hidePrompt: function () {
                ...
                $(".trans-prompt .prompt-wrap").html('<span class="prompt-text prompt-text-left-align">检测失败，请手动选择语言</span>').parent().show(), $(".operate-btn.op-sound").hide(), $(".operate-btn.op-favo").hide()
                ...
                $(".trans-prompt .prompt-wrap").html(o).parent().show(), this.sendShowPromptLog()
            }, onPrompt: function (t) {
                o.fromlangChange({
                    lang: t,
                    trans: !0
                ...
                var o = '<span dir="ltr">';
                o += '<span class="prompt-text" style="margin-left: -42px;">' + t + "</span>", n && (o += '<a href="javascript:" class="prompt-link' + (r ? " " + r : "") + '">' + n + "</a>"), o += "</span>", $(".trans-prompt .prompt-wrap").html(o).parent().show(), e.onHistoryInput(), p.onAdLinkInput()
            }
        };
    n.hide = function () {
        i.hidePrompt()
        ...
        s = {
            clickExchangeBtn: function () {
                ...
                $(".select-from-language .select-inner").animate({
                    left: "241px"
                }, 400), $(".select-to-language .select-inner").animate({
                    left: "-241px"
                }, 400, function () {
                    a.execExchange()
                })
                ...
                var n = $(".select-from-language .language-selected"),
                    ...
                    c = $.trim(s.text()),
                    i = s.attr("data-lang");
                $(".select-inner").stop(!0, !0), n.has("span").length > 0 && (t = n.find("span").text()), n.text(c).attr({
                    "data-lang": i,
                    "data-detected": "0"
                }), s.text(t).attr("data-lang", e), $(".select-inner").css({
                    left: 0
                }), g.fromlangChange({
                    lang: i
                }), l.tolangChange({
...
define("translation:widget/translate/input/processlang", function (n, t, e) {
    ...
    function a(n, t, e) {
        return g.set("detectLang", n), g.get("fromLangIsAuto") ? (t = n, e = $(".select-to-language .language-selected").attr("data-lang")) : n !== e || g.get("langChangedByUser") || ("zh" === e && $.inArray(t, c) >= 0 ? (o.execExchange(!0), e = t, t = n, $(".trans-prompt").hide()) : "zh" === t && $.inArray(e, c) >= 0 && (o.execExchange(!0), e = t, t = n, $(".trans-prompt").hide())), g.set("langChangedByUser", !1), {
            fromLang: t,
            toLang: e
        }
    }
    ...
    function r(n, t, e) {
        return l.includes(t) && l.includes(e) && n === e ? (o.execExchange(!0), e = t, t = n, $(".trans-prompt").hide()) : p.includes(t) && "en" === e || !i.hasOwnProperty(n) || s.renderPrompt(n, !0), {
            fromLang: t,
            toLang: e
        }
    }
...
define("translation:widget/translate/input/translate", function (t, a) {
        ...
        v = {
            onTrans: function (t) {
                ...
                if (l.getByte(t) > s.MAX_QUERY_COUNT) {
                    ...
                    var e = t;
                    a = l.cutByByte(t, 0, s.MAX_QUERY_COUNT).replace(/[\uD800-\uDBFF]$/, ""), e = l.cutByByte(e, s.MAX_QUERY_COUNT, s.MAX_QUERY_COUNT + 9), c.showTip({
                        query: e
                    })
                }
                return a
                ...
                if (null !== a) {
                    ...
                    var p = null;
                    if (o && !d.get("fromLangIsAuto") && s !== a ? p = i.processOcrLang(a, s, l) : (e.show(a, s), p = i.getLang(a, s, l)), "LAN-UNKNOWN" === a && ("auto" === s || g)) {
                        var m = t("translation:widget/translate/input/clear");
                        return void m.clearOutput()
                    }
                    u.show(), $("body").trigger("updateFromTo.domainTrans", p);
                    var f = this,
                    ...
                    w.log(), this.translateXHR && 4 !== this.translateXHR.readyState && this.translateXHR.abort(), this.translateXHR = $.ajax({
                        type: "POST",
                        url: "/v2transapi?from=" + encodeURIComponent(p.fromLang) + "&to=" + encodeURIComponent(p.toLang),
                        cache: !1,
                        data: h
                    }).done(function (t) {
                        d.set("isInRtTransState", !0), f.translateSuccess(t, p.fromLang, p.toLang, n, c)
                    })
                }
                ...
                return n.getVal() ? (r && f.add(a, e, $.trim(r)), f.hideHistory(), h.hide(), o.checkResponse({
                    res: t,
                    from: a,
                    to: e,
                    query: r,
    ...
    a.onTranslate = function (t) {
        ...
        _hmt.push(["_trackEvent", "首页", "59_首页页面_翻译query量_图片"]), v.langIsDeteced(t, a, void 0, !0)
    }
});;
define("translation:widget/translate/domain/domain", function (a, n, t) {
    ...
    function e() {
        b.find(".domain-trans-toast-text").text("已切换到" + C[L] + (L === h.COMMON ? "" : "领域")), $("body").append(b), null != T && clearTimeout(T), T = setTimeout(function () {
            return i()
        }, 2e3)
    }

    function i() {
        b.remove().find(".domain-trans-toast-text").text(""), null != T && (clearTimeout(T), T = null)
    }

    function d() {
        window._hmt.push(["_trackEvent", "首页", "99_首页页面_" + C[L] + "领域发起翻译次数"])
    }
    ...
    function s(a) {
        ...
        case h.WCM:
            var d = void 0,
                r = void 0;
            return "auto" === t ? (d = !1, r = "en" !== o && "zh" !== o) : "zh" === t ? (d = !1, r = "en" !== o) : (d = !0, r = !0), d || r
        }
    }

    function m() {
        M.find("[data-domain-value]").removeClass("active").end().find('[data-domain-value="' + L + '"]').addClass("active"), N.find(".domain-trans-bottom .active").length > 0 && N.find(".domain-trans-bottom").append(N.find(".domain-trans-top .domain-trans-item-wrapper").eq(1)).end().find(".domain-trans-top").append(N.find(".domain-trans-bottom .active").parent()), O.find(".domain-trans-bottom .active").length > 0 && O.find(".domain-trans-bottom").append(O.find(".domain-trans-top .domain-trans-item-wrapper").eq(0)).end().find(".domain-trans-top").append(O.find(".domain-trans-bottom .active").parent()), N.toggleClass("domain-trans-hot", N.find(".domain-trans-top .domain-trans-bm").length > 0), O.toggleClass("domain-trans-hot", O.find(".domain-trans-top .domain-trans-bm").length > 0), $(".output-wrap").attr("data-domain-value", L), e()
    }
    ...
    function l(a) {
        ...
        Object.values(h).forEach(function (a) {
            ...
            M.find('[data-domain-value="' + a + '"]').toggleClass("disable", o)
        })
    }
    ...
    function c() {
        $("body").on("updateFromTo.domainTrans", function (a, n) {
            var t = void 0,
                o = void 0;
            if (null == n ? (t = $(".select-from-language .language-selected").attr("data-lang"), o = $(".select-to-language .language-selected").attr("data-lang")) : (t = n.fromLang, o = n.toLang), s({
                domain: L,
                fromLang: t,
                toLang: o
            })) {
                L = h.COMMON;
                var e = M.find(".domain-trans-common"),
                    i = M.find(".domain-trans-common .domain-trans-item-tip span");
                e.addClass("reset"), i.text(s({
                    domain: h.BM,
                    fromLang: t,
                    toLang: o
                }) ? "当前语种仅支持通用领域" : "当前语种仅支持通用领域、生物医药领域、金融领域"), setTimeout(function () {
                    e.removeClass("reset")
                }, 3e3), m()
            }
            l({
            ...
            L === n || a.hasClass("disable") || (L = n, m(), v.onTranslate({
                transtype: "translang"
            }))
        }).on("click", ".domain-trans-tip-close", function () {
            M.find(".domain-trans-tip").hide()
    ...
    function u() {
        ...
        l({
            ...
            try {
                ...
                if ("yes" === a) return;
                localStorage.setItem("DOMAIN_TRANS_TIP_FLAG", "yes"), M.find(".domain-trans-tip").show(), setTimeout(function () {
                    M.find(".domain-trans-tip").hide()
                }, 5e3)
            } catch (n) {
                M.find(".domain-trans-tip").show(), setTimeout(function () {
                    M.find(".domain-trans-tip").hide()
                }, 5e3)
            }
        }, 16)
    ...
    function f() {
        M.show(), $(".output-wrap").attr("data-domain-value", L)
    }

    function g() {
        M.hide(), $(".output-wrap").attr("data-domain-value", "")
    }
    var p, v = a("translation:widget/translate/input/translate"),
        h = {
            COMMON: "common",
            BM: "medicine",
            ET: "electronics",
        ...
        C = (p = {}, o(p, h.COMMON, "通用领域"), o(p, h.BM, "生物医药"), o(p, h.ET, "电子科技"), o(p, h.WCM, "水利机械"), o(p, h.NOVEL, "网络文学"), o(p, h.FINANCE, "金融"), p),
        L = h.COMMON,
        M = $(".domain-trans-wrapper"),
        N = $(".domain-trans-large"),
        O = $(".domain-trans-small"),
        b = $(['<div class="domain-trans-toast">', '<div class="domain-trans-toast-text"></div>', '<div class="domain-trans-toast-close"></div>', "</div>"].join("")),
        T = null;
    t.exports = {
        getCurDomain: r,
        log: d,
        ...
        m = {
            build: function (t) {
                var e = 1 === parseInt(h.get("firstModuleId"), 10),
                    ...
                    r = !1,
                    d = {};
                "zh" === i && "en" === a ? (r = !0, _hmt.push(["_trackEvent", "首页", "Web中英方向重点词汇卡片展现次数"]), d.direction = "zh2en") : (_hmt.push(["_trackEvent", "首页", "Web英中方向重点词汇卡片展现次数"]), d.direction = "en2zh"), $.each(n, function (t, e) {
                    e.href = "/#" + i + "/" + a + "/" + encodeURIComponent(e.word)
                }), d.dataArray = n, d.meanNeedHighlight = r, d.isFirstCard = e;
                var s = u("tpl-keywords", d);
                f.append(s), n.forEach(function (t, e) {
                    var n = t.word,
                        r = t.means,
                        d = new o.default({
                            pos: "keyword",
                ...
                $(".translate-wrap").on("click", ".keywords-word", function () {
                    ...
                    $.ajax({
                        ...
                        $(".keywords-word").removeClass("selected"), t.addClass("selected"), f.children(":not(.keywords-outter, .keywords-outter-notfirst)").remove(), c.default.init(e, i, o, n, !1, !0)
                    })
...
define("translation:widget/translate/details/sample/sample", function (e, t) {
    "use strict";
    var a, n, l, i, s = e("translation:widget/common/third_party/template"),
        o = e("translation:widget/translate/details/dictionary/simplemeans"),
        r = e("translation:widget/common/soundURIGenerator"),
        u = e("translation:widget/common/environment"),
        g = $("#left-result-container"),
        d = ["《柯林斯高阶英汉双解学习词典》", "《汉英大词典》", "百度翻译例句库", "《牛津高阶英汉双解词典》", "《外研社英语同义词辨析词典》", "中考真题", "高考真题", "四级真题", "六级真题"],
        p = new RegExp(d.join("|")),
        c = void 0,
        m = {
            buildSample: function (e) {
                var t = e.data;
                a = e.from, n = e.to, i = e.query, c = e.badCaseByForce;
                var o = {};
                if (o.tplData = {}, o.tplData.to_lang = n, t["double"] = t["double"].replace(/\\'/g, "'"), t.single = t.single.replace(/\\'/g, "'"), t["double"] = t["double"].replace(/[‘|’]/g, "'"), t.single = t.single.replace(/[‘|’]/g, "'"), t["double"]) {
                    var r = this.getDoubleSample(t["double"], c);
                    o.tplData["double"] = r["double"], o.tplData.badCaseByForce = c, o.tplData.senData = r.senData, l = o
                }
                if (t.single) {
                    t.single = $.parseJSON(t.single), t.senData2 = [];
                    for (var u = 0, d = t.single.length; d > u; u++) {
                        var p, m = "";
                        "zh" === n ? p = t.single[u][0] : "en" === n && (p = t.single[u][1]);
                        for (var h = 0, v = p.length; v > h; h++) m += p[h][0], p[h][3] && (m += p[h][3]);
                        m = encodeURIComponent(m), t.senData2[u] = m;
                        var f = t.single[u][1];
                        if (/^http\:\/\//.test(f)) {
                            f = f.replace(/^http\:\/\//, "");
                            var b = f.indexOf("/");
                            t.single[u][2] = b > 0 ? f.substr(0, b) : f
                        } else t.single[u][2] = t.single[u][1], t.single[u][1] = "#"
                    }
                    o.tplData.single = t.single, o.tplData.senData2 = t.senData2
                }
                if (t.tag && t.tag instanceof Array) {
                    var S = t.tag.length;
                    S && S > 1 && (o.tplData.tag = t.tag, _hmt.push(["_trackEvent", "首页", "web端双语例句子TAB出现"]))
                }
                var D = s("tplSample", o);
                g.append(D)
            }, getDoubleSample: function (e, t) {
                var a = {};
                a["double"] = $.parseJSON(e), a.senData = [];
                for (var l = !0, i = 0, s = a["double"].length; s > i; i++) {
                    ...
                    r = encodeURIComponent(r), a.senData[i] = r, l && !p.test(a["double"][i][2]) && (a["double"][i].isFirstNetSt = !0, l = !1);
                    var d = a["double"][i][2];
                    if (/^https?\:\/\//.test(d)) {
                        d = d.replace(/^https?\:\/\//, "");
                        var c = d.indexOf("/");
                ...
                BTPM.setUrl(a);
                var n;
                t.addClass("op-sound-active"), n && clearTimeout(n), n = setTimeout(function () {
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        if (0 === e.errno && e.data && e.data.st) {
                            ...
                            r.setSampleCollapse(!0), window.scrollTo(0, t)
                        }
                    }
                })
    ...
    function i(a) {
        ...
        if (t) {
            ...
            var s = Math.max.apply(Math, n),
                o = s + 45;
            t.find(".general-box").removeClass("test-position"), r.find(".item-mean").css({
                left: o
            })
        }
    }
    ...
    var u = $("#left-result-container"),
        l = {
            init: function (t) {
                ...
                i.init(t), d.init(t, n), t.onlyEntry = e, t.onlyUnbox = n;
                var r = o("tplOxford", {
                    tplData: t
                });
                u.append(r)
    ...
    var d = $("#left-result-container"),
        ...
        c = {
            init: function () {
                ...
                d.append(a), $(".usecase-nav").find("li").eq(0).addClass("cur"), $(".usecase-cont").find(".usecase-item").eq(0).removeClass("hide"), l.indexOf("Firefox") < 0 && $(".ex-zh").addClass("ex-zh-clamp")
            }, bindEvents: function () {
                var e = this;
                ...
                if (!t.hasClass("cur")) {
                    ...
                    t.addClass("cur").siblings().removeClass("cur"), n.find(".usecase-item").eq(o).removeClass("hide").siblings().addClass("hide"), this.genCollapse({
                        target: s
                    }), i.setupPos(), r && (r.hasClass("oxford-phrasalverb-only") ? this.hideOxford(!1) : (this.hideOxford(!0), $(".oxford-to-collapse").addClass("hide"))), window.scrollTo(0, a)
                }
                ...
                $(".oxford-to-collapse").addClass("hide"), $("html:not(:animated), body:not(:animated)").animate({
                    scrollTop: t
                }, 300, "swing", function () {
...
define("translation:widget/translate/details/details", function (e, a) {
    ...
    function t(a, t, j, O, N) {
        ...
        ! function () {
            if (!a.dict_result || "en" !== j && "zh" !== j && "jp" !== j && "th" !== j) E = !1, b.sendIndexBannerLog();
            else if (a.dict_result.content) N || (E = a.dict_result, q = JSON.stringify(a.dict_result));
            else if (a.dict_result.simple_means && !N && (E = a.dict_result.simple_means, I = a.dict_result.baike_img_url, W = a.dict_result.queryExplainVideo, a.dict_result.simple_means.symbols && a.dict_result.simple_means.symbols.length > 0 && (q = JSON.stringify({
                simple_means: {
                    symbols: a.dict_result.simple_means.symbols
                }
            })), a.dict_result.sim_words && (E.sim_words = a.dict_result.sim_words), a.dict_result.net_means && (E.net_means = a.dict_result.net_means)), "zh" === t && "en" === j || "en" === t && "zh" === j)
                for (var e in a.dict_result)
                    if (a.dict_result[e] instanceof Object && !$.isEmptyObject(a.dict_result[e]) && 0 !== a.dict_result[e].length) switch (e) {
                    case "collins":
                        D.collins = !0;
                        break;
                    ...
                    D.simpleMeaning = Boolean(E), !a.liju_result || "en" !== j && "zh" !== j || !a.liju_result["double"] && !a.liju_result.single || (D.illSen = !0), a.trans_result && a.trans_result.keywords && a.trans_result.keywords.length > 0 && ("zh" === t && "en" === j || "en" === t && "zh" === j) && !D.simpleMeaning && (D.keyWord = !0), a.simworks && "[object Object]" === Object.prototype.toString.call(a.simworks) && (D.translator = !0)
        }();
        var F = [],
            A = !1;
        ! function () {
            if (e("translation:widget/translate/sideNav/navSorter/listOperator").getNavList().forEach(function (e) {
                ...
                var a = [];
                D.festivalLink && a.push("festivalLink"), D.adLink && a.push("adLink"), "simpleMeaning" !== F[0] ? (F.unshift.apply(F, a), D.adLink && D.festivalLink && (A = !0)) : F.splice.apply(F, [1, 0].concat(a))
            }
        ...
        var R = !1;
        for (var U in D) R = R || D[U];
        C || (R && ("en" === t && "zh" === j && O.length < 417 && window.common.hasSideAd && l.build(), s.set("hasDetail", !0), n.showAppQr(A)), f.init({
            from: t,
            to: j,
            query: O,
            dictJSON: q
        })), "en" === t && "zh" === j || "zh" === t && "en" === j ? (y.genCollapse(), k.genNav(C ? !1 : !0)) : k.destroyNav()
    }
...
define("translation:widget/translate/docTransLang/docTransLang", function (o) {
    "use strict";
    ...
    function t(o) {
        var t = n(o),
            a = t.from,
            r = t.to;
        g.removeClass("selected"), g.filter('[data-dir="' + o + '"]').addClass("selected");
        var e = "auto2auto" === o;
        l.toggleClass("auto", e), e ? l.find(".from-doc-lang").text("中英互译") : (l.find(".from-doc-lang").text(s[a].zhName), l.find(".to-doc-lang").text(s[r].zhName)), d.removeClass("open"), f.from = a, f.to = r
    }
    ...
    function a() {
        c.removeClass("guiding"), localStorage.setItem("docTransLangGuideFlag", "true")
    }
    var r = Object.assign || function (o) {
        ...
        e = o("translation:widget/translate/input/uploader"),
        i = o("translation:widget/translate/docTranslate/docTransUtil"),
        s = o("translation:widget/common/config/langMap"),
        c = $(".doc-trans-operation"),
        d = $(".doc-trans-dir"),
        l = d.find(".curr-doc-dir"),
        m = d.find(".doc-lang-select"),
        g = m.find(".doc-lang-pair"),
        u = m.find(".know-btn"),
        f = {
            from: "auto",
            to: "auto"
    ...
    ! function () {
        var n = localStorage.getItem("docTransDir");
        n && t(n), $(".doc-trans-btn").on("click", function () {
            window.common.docLangHit ? e.option("formData", r({}, f, {
                sid: 1152020
            })) : window.common.domainHit ? e.option("formData", r({}, f, {
                sid: window.common.docSid
            })) : e.option("formData", f), e.upload(i.currTask.file), Object.assign(i.currTask, f);
            var t = o("translation:widget/translate/docTranslate/docTranslate");
            t.loading(), $("#main-outer").removeClass("doc-trans-mode").addClass("doc-trans-view-mode"), $(".footer").hide(), console.log(0), window._hmt.push(["_trackEvent", "首页", "80_首页页面_点击文档翻译的翻译按钮"]), "auto" === f.from && "auto" === f.to && window._hmt.push(["_trackEvent", "首页", "81_首页页面_点击文档翻译的翻译按钮时语言方向为中英互译"])
        }), l.on("click", function () {
            d.toggleClass("open"), a()
        }), g.on("click", function (o) {
            var n = $(o.currentTarget).attr("data-dir");
            localStorage.setItem("docTransDir", n), t(n), a()
        }), u.on("click", function () {
            a(), d.removeClass("open")
        }), $("body").on("click", function (o) {
            var t = $(o.target);
            0 !== d.find(t).length || t.is(d) ? window._hmt.push(["_trackEvent", "首页", "文档翻译_点击语言设置框"]) : d.removeClass("open")
        })
    }()
});;
    ...
    var e = n("translation:widget/common/sendLog"),
        ...
        a = {
            init: function () {
                ...
                a && (t.op_type = "ald" + a), e.sendIndexDisplayLog(t), r.testCookie() || e.sendIndexFeatureLog({
                    action: "nocookie"
...
define("translation:widget/translate/input/input", function (t) {
    ...
    t("translation:widget/common/flash"), $(function () {
        n.init(), a.init(), t("translation:widget/translate/input/autoRequest").compatibleTrans(), alog("speed.set", "drt", +new Date)
    ...
    var t = e("translation:widget/common/environment"),
        ...
        d = {
            init: function () {
                ...
                try {
                    "true" !== localStorage.getItem("PC2.10CollBtnTagClicked") && $(".collection-btn").addClass("new-edition-tip"), "true" !== localStorage.getItem("PC3.5SettingBtnTagClicked") && $(".setting-btn").addClass("new-edition-tip")
                } catch (e) {}
                ...
                d ? "0" === d ? ($(".history-switch").removeClass("setting-checked"), t.set("isInHistoryMode", !1), r.updateAppSideAdLong()) : "1" === d && (t.set("isInHistoryMode", !0), r.updateAppSideAdLong()) : (s.setCookie("HISTORY_SWITCH", 1, {
                    expires: 864e8
                }), t.set("isInHistoryMode", !0), r.updateAppSideAdLong());
                var a = s.getCookie("SOUND_SPD_SWITCH");
                a ? "0" === a ? ($("#spd-slow").addClass("sound-spd-radio-checked"), t.set("soundSpdMode", "slow")) : "2" === a ? ($("#spd-fast").addClass("sound-spd-radio-checked"), t.set("soundSpdMode", "fast")) : ($("#spd-normal").addClass("sound-spd-radio-checked"), t.set("soundSpdMode", "normal")) : (s.setCookie("SOUND_SPD_SWITCH", 1, {
                    expires: 864e8
                }), $("#spd-normal").addClass("sound-spd-radio-checked"), t.set("soundSpdMode", "normal"));
                var c = s.getCookie("SOUND_PREFER_SWITCH");
                c ? "0" === c ? ($("#prefer-uk").addClass("sound-prefer-radio-checked"), t.set("soundPreferMode", "uk")) : ($("#prefer-en").addClass("sound-prefer-radio-checked"), t.set("soundPreferMode", "en")) : (s.setCookie("SOUND_PREFER_SWITCH", 1, {
                    expires: 864e8
                ...
                l || (l = "hover", n.supportLocalStorage && localStorage.setItem("soundTrigger", l)), $("#" + l + "-trigger").addClass("sound-trigger-radio-checked"), t.set("soundTriggerMode", l)
            }, bindEvents: function () {
                ...
                n.supportLocalStorage && "true" !== localStorage.getItem("PC3.5SettingBtnTagClicked") && (localStorage.setItem("PC3.5SettingBtnTagClicked", "true"), $(".setting-btn").removeClass("new-edition-tip")), $(".translate-setting .setting-options").toggle(), $(".setting-btn").toggleClass("setting-btn-focus"), _hmt.push(["_trackEvent", "首页", "web端点击设置"])
                ...
                var o;
                e.hasClass("setting-checked") ? (t.set("isInRealtimeMode", !0), o = 1, _hmt.push(["_trackEvent", "首页", "web端实时翻译打开"])) : (t.set("isInRealtimeMode", !1), o = 0, _hmt.push(["_trackEvent", "首页", "web端实时翻译关闭"])), s.setCookie("REALTIME_TRANS_SWITCH", o, {
                    expires: 864e8
                })
                ...
                e.toggleClass("setting-checked");
                var o;
                e.hasClass("setting-checked") ? (o = 1, t.set("isInFanyiWordMode", !0), _hmt.push(["_trackEvent", "首页", "web端划词翻译打开"])) : (o = 0, t.set("isInFanyiWordMode", !1), _hmt.push(["_trackEvent", "首页", "web端划词翻译关闭"])), s.setCookie("FANYI_WORD_SWITCH", o, {
                    expires: 864e8
                })
                ...
                e.toggleClass("setting-checked");
                var o;
                e.hasClass("setting-checked") ? (o = 1, t.set("isInHistoryMode", !0), r.updateAppSideAdLong(), _hmt.push(["_trackEvent", "首页", "设置-历史记录-开启"])) : (o = 0, t.set("isInHistoryMode", !1), r.updateAppSideAdLong(), _hmt.push(["_trackEvent", "首页", "设置-历史记录-关闭"])), i.onHistoryInput(), s.setCookie("HISTORY_SWITCH", o, {
                    expires: 864e8
                })
            }, soundSpdSwitch: function (e) {
                var o = $(e.currentTarget);
                if (!o.hasClass("sound-spd-radio-checked")) {
                    $(".sound-spd-switch .sound-spd-radio-checked").removeClass("sound-spd-radio-checked"), o.addClass("sound-spd-radio-checked");
                    ...
                    "slow" === i ? (s.setCookie("SOUND_SPD_SWITCH", 0, {
                        ...
                        expires: 864e8
                    }), _hmt.push(["_trackEvent", "首页", "设置-发音语速-较快"])), t.set("soundSpdMode", i)
                }
            }, soundPreferSwitch: function (e) {
                var o = $(e.currentTarget);
                if (!o.hasClass("sound-prefer-radio-checked")) {
                    $(".sound-prefer-switch .sound-prefer-radio-checked").removeClass("sound-prefer-radio-checked"), o.addClass("sound-prefer-radio-checked");
                    var i = o.attr("data-value");
                    "en" === i ? (s.setCookie("SOUND_PREFER_SWITCH", 1, {
                        expires: 864e8
                    }), _hmt.push(["_trackEvent", "首页", "设置-英语发音偏好-美式"])) : (s.setCookie("SOUND_PREFER_SWITCH", 0, {
                        expires: 864e8
                    }), _hmt.push(["_trackEvent", "首页", "设置-英语发音偏好-英式"])), t.set("soundPreferMode", i)
                }
            }, soundTriggerSwitch: function (e) {
                var s = $(e.currentTarget);
                if (!s.hasClass("sound-trigger-radio-checked")) {
                    $(".sound-trigger-switch .sound-trigger-radio-checked").removeClass("sound-trigger-radio-checked"), s.addClass("sound-trigger-radio-checked");
                    var o = s.attr("data-value");
                    n.supportLocalStorage && localStorage.setItem("soundTrigger", o), _hmt.push(["_trackEvent", "首页", "设置-发音模式-" + o]), t.set("soundTriggerMode", o)
                }
            }
        };
    $(function () {
...
define("translation:widget/translate/translang/translang", function (t) {
    "use strict";
    t("translation:node_modules/react-app-polyfill/ie11"), t("translation:node_modules/react-app-polyfill/stable");
    var n = (t("translation:widget/common/environment"), t("translation:widget/translate/translang/fromlang")),
        ...
        i = {
            init: function () {
                ...
                $(".trans-operation-wrapper").on("click", ".select-from-language", $.proxy(this.clickFromBtn, this)).on("click", ".select-to-language", $.proxy(this.clickToBtn, this)).on("click", ".from-to-exchange", $.proxy(this.clickExchangeBtn, this)), $("#translate-button").on("click", $.proxy(this.clickTranslate, this)), $(".manual-trans-btn").on("click", function () {
                ...
                s.fromBtnClicked(), _hmt.push(["_trackEvent", "首页", "web端点击源语言button"])
            }, clickToBtn: function () {
                s.toBtnClicked(), _hmt.push(["_trackEvent", "首页", "web端点击目标语言button"])
            }, clickExchangeBtn: function () {
                e.clickExchangeBtn(), _hmt.push(["_trackEvent", "首页", "点击翻译方向切换箭头"])
            }, clickTranslate: function () {
                l.transBtnClicked(), _hmt.push(["_trackEvent", "首页", "web端翻译button点击次数"])
    ...
    var t = o("translation:widget/translate/zonedword/wordWrap"),
        ...
        d = {
            init: function () {
                ...
                var n;
                t.hasClass("setting-checked") ? (n = 1, r.set("isInFanyiWordMode", !0)) : (n = 0, r.set("isInFanyiWordMode", !1), _hmt.push(["_trackEvent", "首页", "Web点击划词翻译框关闭划词翻译功能"])), s.setCookie("FANYI_WORD_SWITCH", n, {
                    expires: 864e8
                })
...
define("translation:widget/footer/extra/extra", function (n, t) {
    ...
    function i() {
        $(window).on("resize", o), s.on("click", a), c.on("click", function () {
            _hmt.push(["_trackEvent", "首页", "96_首页页面_右侧悬浮按钮点击"]), window.open("https://fanyi.baidu.com/appdownload/download.html")
        })
    }
    ...
    function a(n) {
        n.preventDefault(), $("html, body").animate({
            scrollTop: 0
        }, 250), _hmt.push(["_trackEvent", "index", "web端回到顶部按钮点击"])
    }
    ...
    $(window).on("scroll", function () {
        ...
        n > 0 ? (s.css("display", "block"), c.css("display", "block"), _hmt.push(["_trackEvent", "首页", "95_首页页面_右侧悬浮按钮展现"])) : (s.hide(), c.hide())
    })
});;
define("translation:widget/footer/follow/follow", function (o, t) {
    ...
    function i() {
        $("#follow-btns").on("click", a), $("#fdialog-wrap").on("click", l)
    }
...
define("translation:widget/footer/footer", function (n) {
    "use strict";
    var t = (n("translation:widget/translate/input/dataTransfer"), $("#main-outer"), $("#preview-img"), $(".footer")),
